...
}else if(isset($_SESSION['name']) && $_SESSION['user_type']=='referee'){
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($num_rows>0){
    ...
    if ($_SESSION['user_type']=='Refree') {
      # code...
      ?>
  <script>
   window.location = "referee/index.php";
 </script>
   <?php
  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        <div class="card-header bg-info">Referee and Admin Login</div>
        <div class="card-body">
           <form method="POST" action="#">
                                <fieldset>
                                    <div class="form-group">
                                       
                                        <input class="form-control" placeholder="Enter Username or Email Address" id="email" name="user" type="text"  required>
                                      </div>
                                    <div class="form-group">

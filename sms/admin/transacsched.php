...
include "theme/header.php";
            ...
            $game_id =$_POST['gtype'];
            $refree_id =$_POST['refree'];
          // $no_teams =$_POST['teamNo'];
          //   $no_player =$_POST['playersNo'];
    ...
    //                     }
     ...
     $result1 = mysqli_query($db, $query1) or die (mysqli_error($db));
              ...
              foreach($_POST['school'] as $value)
            {
                ...
                (type_code,tour_code,game_id,facilitator_code,venue_code,match_date,match_time,time_end,match_code,sy_code,school_code,Is_have_result,match_status, refree_id)
                VALUES ('".$type."','".$tname."','".$game_id."','".$facilitator."','".$venue."','".$date."','".$start."','".$end."','".$match_code."','".$sy_code."','".$value."','NO','".$status."', '".$refree_id."')";

   ...
   echo '<header>
    ...
    if($no == 0) {
      ...
      while ($row5 = mysqli_fetch_array($rs123)) {
        ...
        echo '<h6>'.$rs3['position_name'].'</h6>';
        echo '<h6>'.$row5['team_name'].'</h6>';
        echo '<h6>'.$row5['final_score'].'</h6>';
